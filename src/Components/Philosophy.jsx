...
const Philosophy = () => {
  return (
    <div className='w-screen min-h-screen '>
        ...
        <div className='text-[#7d8abc] w-11/12 ml-5 sm:ml-0'>
            ...
            <p className='w-10/12 mt-10 text-justify'>
            Who we are is a realization of the thoughts we have. However, our minds, the source of our thoughts, are not thought of enough. Our minds fight their own battles, stress, anxiety, depression, and so much more. In fact, over 180 million Indians battle disorders of the mind, corresponding to around 14% of our population.
            </p>
            <p className='w-10/12 mt-10 text-justify'>
